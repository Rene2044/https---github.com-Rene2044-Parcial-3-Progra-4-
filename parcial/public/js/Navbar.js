...
<nav class="bg-white/10 backdrop-blur-lg border-b border-white/10 shadow-lg fixed top-0 left-0 w-full z-50">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block ml-12">
                    <div class="flex items-baseline space-x-6">
                        <a href="/" class="text-white hover:text-yellow-400 px-3 py-2 text-sm font-medium transition-colors">Inicio</a>
    ...
    <div id="mobile-menu" class="md:hidden max-h-0 overflow-hidden transition-all duration-300 ease-in-out bg-slate-900/90 backdrop-blur-xl">
        <div class="px-6 pt-4 pb-8 space-y-2 border-t border-white/10">
            <a href="/" class="text-white block px-4 py-3 rounded-xl text-base font-medium hover:bg-white/10">Inicio</a>
            <a href="/historial" class="text-white/70 block px-4 py-3 rounded-xl text-base font-medium hover:bg-white/10">Historial</a>
            <a href="/mapas" class="text-white/70 block px-4 py-3 rounded-xl text-base font-medium hover:bg-white/10">Mapas</a>
            <a href="/login" class="text-white/70 block px-4 py-3 rounded-xl text-base font-medium hover:bg-white/10">Login</a>
