...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('assets/Cap.png') }}">
...
<body class="weather-bg flex flex-col items-center min-h-screen p-0 m-0 w-full overflow-x-hidden font-['Inter']">
    ...
    <div class="flex flex-col lg:flex-row items-start justify-center gap-8 w-full max-w-7xl mx-auto mt-32 px-6 flex-grow">
        ...
        <main class="w-full lg:max-w-xl bg-white/20 backdrop-blur-lg rounded-[32px] shadow-2xl p-8 border border-white/30 text-white transition-all duration-500">
            <div class="relative mb-8">
                <input type="text" id="city-input" placeholder="Buscar ciudad..." class="w-full bg-white/10 border border-white/10 rounded-2xl py-4 px-6 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-yellow-400/50 transition-all">
            ...
            <div class="grid grid-cols-3 gap-4 text-center bg-black/20 backdrop-blur-md rounded-3xl p-6 mb-10 border border-white/5">
                <div class="flex flex-col"><p class="text-[10px] uppercase tracking-widest opacity-50 mb-2">Humedad</p><p class="font-bold text-xl" id="humidity">--</p></div>
                <div class="flex flex-col border-x border-white/10"><p class="text-[10px] uppercase tracking-widest opacity-50 mb-2">Viento</p><p class="font-bold text-xl" id="wind-speed">--</p></div>
                <div class="flex flex-col"><p class="text-[10px] uppercase tracking-widest opacity-50 mb-2">Visibilidad</p><p class="font-bold text-xl" id="visibility">--</p></div>
            </div>

            <section>
                <h3 class="text-xs font-bold uppercase tracking-[0.2em] mb-6 opacity-60">Pronóstico 5 días</h3>
                <div class="flex justify-between overflow-x-auto gap-4 pb-2 custom-scrollbar" id="forecast-container"></div>
            </section>
        </main>
    ...
    <script type="module" src="{{ asset('js/Aside.js') }}"></script>
    <script type="module" src="{{ asset('js/weatherService.js') }}"></script>
